        ...
        <section class="main-container slide-in">
            <div class="modules-grid">
                ...
                const slides = [
                    ...
                    { title: "Chapter 3", file: "06_Ch03-org-sys-federico.pdf" },
                    { title: "Chapter 4", file: "07_Ch4_changing-comp-env.pdf" },
                    { title: "Chapter 5", file: "08_Ch5_resource.pdf" },
                ...
                return slides.map(slide => `
                    ...
                    <div class="glass-card">
                        ...
                        <ul style="list-style: none; padding: 0;">
                            ...
                            <li style="margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px solid rgba(255,255,255,0.1);">
                                <h3 style="color: var(--color-primary); margin-bottom: 0.5rem;">Week of April 14</h3>
                                <p>Class held by Prof. Pigni</p>
                            </li>
                            <li style="margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px solid rgba(255,255,255,0.1);">
